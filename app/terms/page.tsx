...
export const metadata: Metadata = {
  title: 'Terms & Conditions | yHD AGENCY',
  description: 'Terms and conditions for using the yHD AGENCY website and contacting our digital studio.',
};
    ...
    <StaticPage>
      <article className="mx-auto max-w-4xl px-5 py-24 sm:px-8 sm:py-32">
        ...
        <div className="prose-yhd mt-12">
          <p>By using the yHD AGENCY website, you agree to use it lawfully and respectfully. These terms describe the basic conditions for browsing the site and sending an enquiry.</p>
          <h2>Website content</h2>
          <p>The text, visual identity, portfolio presentation, and code on this website are provided for general information about yHD AGENCY. Content may change without notice. We make reasonable efforts to keep information accurate, but do not guarantee that every page is complete or error-free.</p>
          ...
          <p>To the extent permitted by law, yHD AGENCY is not responsible for losses arising from reliance on general website information, third-party services, unavailable links, or interruptions beyond our reasonable control.</p>
          <h2>Updates</h2>
